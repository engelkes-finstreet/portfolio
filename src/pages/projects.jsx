...
const projects = [
  ...
  },
  {
    ...
    description:
      'Online presence for a car dealership',
  ...
  },
  {
    ...
    link: { href: 'http://finanzierungsporta.ermoeglicher.de', label: 'finanzierungsportal.ermoeglicher.de' },
    role: "Software Architect",
    achievements: [
        ...
        >
          {projects.map((project) => (
            <Card as="li" key={project.name}>
              ...
              <Card.Description className="h-20">{project.description}</Card.Description>
            <ul role="list" className="list-disc list-inside text-sm text-zinc-600 dark:text-zinc-400 mt-4">
                {
